      ...
      <div className="max-w-md mx-auto">
        <div className="text-center mb-8">
          <div className="flex items-center justify-center gap-2 mb-6">
            ...
            <h2 className="text-3xl font-bold text-gray-900">CervicalScan AI</h2>
          </div>
        ...
        <div className="bg-white py-8 px-4 shadow-lg rounded-lg sm:px-10">
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <Button type="submit" className="w-full flex justify-center" icon={LogIn}>
              Sign In
            </Button>
          ...
          <div className="mt-6">
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-2 bg-white text-gray-500">New to CervicalScan AI?</span>
              </div>
            </div>
